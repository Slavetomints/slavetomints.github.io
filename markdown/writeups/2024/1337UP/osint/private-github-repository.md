...
![A GitHub Gist, where Bob Robizillo asks TIffany to add a key to her account](image1.png)
...
![A Picture of CyberChef, the current recipe is From Base64 and then Unzip](image2.png)
...
![output of cat id_rsa, its a openssh private key](image3.png)
...
![Adding the key to our session](image4.png)

![Cloning Bob Robizillo's 1337up repository](image5.png)
...
![Poking around the repository](image6.png)
...
![Poking around Tiffany's 1337 repository](image9.png)
...
![git log on the repository](image10.png)

![VsCode](image11.png)

![The changelog for the commits in VSCode](image12.png)

Another repository! Ugh this is getting kind tedious, but nevertheless, lets clone that one and check it out

![cloning the other repository](image13.png)

![finding the flag!](image14.png)
