...
By calling `--incremental` after `john` we are telling it we want to try every single combination of the 95 printable ASCII characters.
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTExOTcyODI5NTldfQ==
-->