...
```
This check firstly if Nmap exists and then if it does it checks the version of Nmap installed. If nothing shows up, then you might need to install Nmap
<!--stackedit_data:
eyJoaXN0b3J5IjpbODYzOTQxMjU5XX0=
-->